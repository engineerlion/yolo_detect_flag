...
def put_text(ids,img):
    #for cat in category:
    
    idx = categories[ids]['id']
    label = categories[ids]['name']
...
def plot_one_box(x, im, color=(128, 128, 128), label=None,clss=None, line_thickness=3):
...
def plot_one_label(im, label=None,clss=None):
    if label:
        put_text(clss,im)
        #return im
